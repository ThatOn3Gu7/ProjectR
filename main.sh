...
EOF
  ...
  echo -e "${BARR}    ║${RST}${OPT} [${WHI}05${OPT}] Htop          ${INFO}- Process viewer ${OPT}(Min)${RST}"
  echo -e "${BARR}    ║${RST}${OPT} [${WHI}06${OPT}] Fish          ${INFO}- Friendly shell ${OPT}(Min)${RST}"
  echo -e "${BARR}    ║${RST}${OPT} [${WHI}07${OPT}] OpenSSH       ${INFO}- SSH access ${OPT}(Dev)${RST}"
  echo -e "${BARR}    ║${RST}${OPT} [${WHI}08${OPT}] Python        ${INFO}- Programming language ${OPT}(Min)${RST}"
  echo -e "${BARR}    ║${RST}${OPT} [${WHI}09${OPT}] Nmap          ${INFO}- Network scanning ${OPT}(Min)${RST}"
